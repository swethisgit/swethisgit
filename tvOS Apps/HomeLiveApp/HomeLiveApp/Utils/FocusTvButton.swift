...
open class FocusTvButton: UIButton {
    ...
    @objc
    @IBInspectable public var focusedBackgroundColor: UIColor = .clear {
        didSet { updateView() }
    }
    ...
    @objc
    @IBInspectable public var focusedAlpha: CGFloat = 0 {
        didSet { updateView() }
    }
    ...
    @objc
    @IBInspectable public var focusedScaleFactor: CGFloat = 1 {
        didSet { updateView() }
    }
    ...
    @objc
    @IBInspectable public var focusedTitleColor: UIColor = .clear {
        didSet { updateView() }
    }

    @objc
    @IBInspectable public var normalTitleColor: UIColor = .clear {
        didSet { updateView() }
    }
