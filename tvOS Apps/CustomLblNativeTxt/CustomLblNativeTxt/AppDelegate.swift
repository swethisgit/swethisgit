...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        TVInterfaceFactory.shared().extendedInterfaceCreator = CustomisedElements()
        TVElementFactory.registerViewElementClass(TVViewElement.self, elementName: CustomisedElements.labelName)
        TVElementFactory.registerViewElementClass(TVImageElement.self, elementName: CustomisedElements.customImage)
