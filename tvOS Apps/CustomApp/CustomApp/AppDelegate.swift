...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    static let tvBaseURL = "http://192.168.1.15:9001/"
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        TVInterfaceFactory.shared().extendedInterfaceCreator = CustomImage()
        TVElementFactory.registerViewElementClass(TVViewElement.self, elementName: CustomImage.templateName)
